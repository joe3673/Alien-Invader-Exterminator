...
# Confirm set up by using echo $LBC_REPO_NAME and it should return what you typed in.
...
export LBC_GROUP_NAME=hjbbdevelopment
export LBC_REPO_NAME=ata-lbc-project-holdenbourg
